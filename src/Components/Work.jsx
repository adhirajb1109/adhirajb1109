...
export default function Work() {
  ...
  useEffect(() => {
    fetch("https://api.github.com/users/AdhirajBhatia/repos")
      .then((res) => res.json())
      .then((data) => {
        setProjects(data);
  ...
  return (
    <div className="animate__animated animate__lightSpeedInLeft work">
      ...
      {projects.map((project) => (
        <div className="card my-4 mx-4 d-inline-block" style={{ width: "21rem" }}>
          <div className="card-body">
            <h5 className="card-title">{project.name.replaceAll("-", " ")}</h5>
            ...
            <a href={project.homepage}>
              <button className="btn">
                <img
                  src="https://i.postimg.cc/cLPP1ksk/25284-removebg-preview.png"
                  className="i"
                  alt="opensite"
                />
              </button>
